...
class Dataset1ViewSet():
    ...
    def populate_database(request):
        ...
        #get csv file
        response = requests.get('https://bluebase.blob.core.windows.net/internship/df_1.csv')

        #rename headers to match models
        full = "id,title,developer,publisher1,publisher2,release_date1,release_date2\n" + response.text

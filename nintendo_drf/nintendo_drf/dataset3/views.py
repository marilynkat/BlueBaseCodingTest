...
class Dataset3ViewSet():
    ...
    def populate_database(request):
        ...
        #get csv file
        response = requests.get('https://bluebase.blob.core.windows.net/internship/df_4.csv')

        #rename headers to match models
        full = "id,title,cancellation_date,developer,publisher\n" + response.text
